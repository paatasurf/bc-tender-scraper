...
def _enqueue_tender_scrape_step(
    ...
    actual_run_id = _prepare_tender_scrape_run_id(run_id)
...
def _prepare_tender_scrape_run_id(run_id: str | None) -> str:
    """Bind standalone tender scraper endpoints to one coordinator run."""
    ...
    begin_tender_scrape(actual_run_id)
