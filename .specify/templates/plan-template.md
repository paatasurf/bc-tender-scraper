...
| IV. Consistent API JSON | Endpoints use shared response envelope and naming convention | ☐ |
| V. Python-Native Scoring | Scoring logic in Python modules, not prompts or frontend | ☐ |

If any gate cannot pass, document justification in Complexity Tracking below.
